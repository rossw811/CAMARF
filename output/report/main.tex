...
\caption{Cumulative portfolio P\&L equity curve (IS and OOS holdout).}
\label{fig:equity}
\end{figure}
...
\caption{DCC-GARCH rolling cross-pair correlations. Dashed line: concentration-risk threshold (0.70).}
\label{fig:dcc}
\end{figure}
