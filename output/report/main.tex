...
$p = 0.981$ rejecting the null of no timing skill. Out-of-sample
...
\begin{enumerate}
  ...
  \item \textbf{Meta-labeling on spread resolution with conformal calibration.}
    ...
    ML paper. (Training data insufficient as of 2026-06-30; reported as an
...
training data as of 2026-06-30 ($n=40$ labeled examples, 5 in minority
...
\textbf{Gold} ($n=3$): \textbf{13} pairs.
\textbf{Silver} ($n=2$): 9 pairs.
\textbf{Bronze} ($n=1$): 1 pairs.
\textbf{Conflict flags} (EG confirms, KPSS rejects simultaneously): 9 pairs.

The high conflict count (9\ of 23)
...
\begin{itemize}
  \item \textbf{In-sample} ($n = 620$ trades): $p = 0.981$ (\textbf{not significant}).
...
\begin{itemize}
  \item ML meta-labeling layer is architecturally complete but awaiting sufficient
    training data ($n = 40$ labeled examples as of 2026-06-30; need 30/class).
...
AMD/DD & 1h & \textbf{Gold} & 0.024 & 0.05 & 0.216 & 0.000 \\
LNT/VTR & 1h & \textbf{Gold} & 0.041 & 0.08 & 0.354 & 0.000 \\
LNT/WELL & 1h & \textbf{Gold} & 0.011 & 0.03 & 0.456 & 0.000 \\
AME/DD & 1h & \textbf{Gold} & 0.000 & 0.06 & 0.514 & 0.000 \\
AMAT/DD & 1h & \textbf{Gold} & 0.000 & 0.04 & 0.226 & 0.000 \\
CMI/DD & 1h & \textbf{Gold} & 0.000 & 0.04 & 0.189 & 0.000 \\
DAL/DD & 1h & \textbf{Gold} & 0.002 & 0.03 & 0.275 & 0.000 \\
EG/WRB & 1h & \textbf{Gold} & 0.026 & 0.03 & 0.251 & 0.000 \\
EG/ORI & 1h & \textbf{Gold} & 0.015 & 0.07 & 0.112 & 0.000 \\
PFG/STLD & 1h & \textbf{Gold} & 0.019 & 0.11 & 0.301 & 0.000 \\
TMHC/WAL & 1h & \textbf{Gold} & 0.033 & 0.13 & 0.098 & 0.000 \\
UMBF/FHB & 1h & \textbf{Gold} & 0.034 & 0.17 & 0.465 & 0.000 \\
SPY/VOO & 4h & \textbf{Gold} & 0.000 & 0.35 & 0.107 & 0.000 \\
HAL/NOV & 1h & Silver & 0.035 & 0.07 & 0.014 & 0.000 \\
MET/TMHC & 1h & Silver & 0.029 & 0.06 & 0.022 & 0.000 \\
PRU/AXTA & 1h & Silver & 0.045 & 0.07 & 0.000 & 0.000 \\
VRT/MTZ & 1h & Silver & 0.002 & 0.08 & 0.000 & 0.000 \\
MTSI/WCC & 1h & Silver & 0.040 & 0.07 & 0.027 & 0.000 \\
EQR/INVH & 30m & Silver & 0.026 & 0.20 & 0.006 & 0.001 \\
CVX/OXY & 3m & Silver & 0.037 & 0.42 & 0.000 & 0.000 \\
KVUE/KMB & 3m & Silver & 0.013 & 0.98 & 0.000 & 0.000 \\
PNC/ZION & 4h & Silver & 0.046 & 0.12 & 0.000 & 0.012 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
IS (Layer 1) & 1028 & 5.29 & --- & \$264,926 & \$1,877 & 0.63 & 15 \\
...
\midrule
KVUE/KMB & 3m & 1.296 & 0.1 & --- & \checkmark \\
CVX/OXY & 3m & 1.162 & 0.1 & --- & \checkmark \\
TMHC/WAL & 1h & 0.510 & 0.1 & 3.153 & \checkmark \\
PNC/ZION & 4h & 0.470 & 0.0 & --- & \checkmark \\
CMI/DD & 1h & 0.462 & 0.1 & --- & \checkmark \\
VRT/MTZ & 1h & 0.457 & 0.1 & -1.695 & \checkmark \\
AMD/DD & 1h & 0.444 & 0.2 & --- & \checkmark \\
MET/TMHC & 1h & 0.427 & 0.0 & -1.985 & \checkmark \\
PRU/AXTA & 1h & 0.398 & 0.0 & 5.890 & \checkmark \\
EG/ORI & 1h & 0.388 & 0.1 & --- & \checkmark \\
AME/DD & 1h & 0.369 & 0.1 & --- & \checkmark \\
PFG/STLD & 1h & 0.369 & 0.0 & -2.757 & \checkmark \\
UMBF/FHB & 1h & 0.332 & 0.0 & 0.732 & \checkmark \\
EG/WRB & 1h & 0.312 & 0.1 & --- & \checkmark \\
EQR/INVH & 30m & 0.301 & 0.0 & --- & \checkmark \\
DAL/DD & 1h & 0.299 & 0.1 & --- & --- \\
MTSI/WCC & 1h & 0.298 & 0.1 & -1.814 & --- \\
LNT/VTR & 1h & 0.287 & 0.1 & -1.626 & --- \\
AMAT/DD & 1h & 0.261 & 0.2 & --- & --- \\
HAL/NOV & 1h & 0.241 & 0.0 & --- & --- \\
LNT/WELL & 1h & 0.217 & 0.1 & 1.752 & \checkmark \\
SPY/VOO & 4h & 0.051 & 0.0 & --- & --- \\
7267.T/8058.T & 1M & --- & --- & --- & --- \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
In-sample & 1028 & 295 & 11.64 & 13.11 & 14.27 & 0.981 & No \\
Out-of-sample & 296 & 70 & 10.24 & 12.10 & 14.34 & 0.904 & No \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\textbf{GARCH(1,1) + Normal$^{\dagger}$} & 4 & -428.4 & \textbf{864.9} & 879.6 \\
Skew-Normal (NIG proxy) & 3 & -9722.4 & 19450.7 & 19466.3 \\
Student-$t$ & 3 & -9748.4 & 19502.9 & 19518.4 \\
Laplace & 2 & -9809.0 & 19622.1 & 19632.4 \\
Normal & 2 & -9909.7 & 19823.4 & 19833.7 \\
\bottomrule
\end{tabular}
\end{table}
